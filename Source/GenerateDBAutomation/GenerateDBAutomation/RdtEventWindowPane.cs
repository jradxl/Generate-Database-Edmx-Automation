...
using Company.VSPackageCM;
using Company.VSPackageCM.Resources;
...
namespace MyCompany.RdtEventExplorer
{
    ...
    public class RdtEventWindowPane : ToolWindowPane
    {
            ...
            base(null)
        {
            ...
            this.ToolBar = new CommandID(GuidList.guidRdtEventExplorerCmdSet, PkgCmdIDList.IDM_MyToolbar);
        ...
        public override void OnToolWindowCreated()
        {
            ...
            CommandID id = new CommandID(GuidList.guidRdtEventExplorerCmdSet, PkgCmdIDList.cmdidRefreshWindowsList);
            DefineCommandHandler(new EventHandler(this.RefreshGrid), id);

            id = new CommandID(GuidList.guidRdtEventExplorerCmdSet, PkgCmdIDList.cmdidClearWindowsList);
            DefineCommandHandler(new EventHandler(this.ClearGrid), id);
        ...
        private OleMenuCommand DefineCommandHandler(EventHandler handler, CommandID id)
        {
            ...
            GenDBAutomationPackage package = (GenDBAutomationPackage)this.Package;
